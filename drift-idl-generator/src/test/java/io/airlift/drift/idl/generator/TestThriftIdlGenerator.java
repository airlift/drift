...
public class TestThriftIdlGenerator
{
    ...
    public void testGenerator()
            throws Exception
    {
        assertGenerated(DriftScribe.class, "scribe", _ -> {});
        assertGenerated(RenamedService.class, "renamed", _ -> {});
        assertGenerated(Fruit.class, "fruit", _ -> {});
        assertGenerated(TreeNode.class, "tree", _ -> {});
